...
With all the requirements defined, I've moved on to making an implementation plan, with major phases and tasks. The main plan was to use the approach of Spec-Driven Development, where you first create one or multiple documents with all the information about the project achitecture, rules and features, so then it gets fed to the AI to do the "heavy lifting". It presents the advantages of AI development, which is much more quicker, and the usage of well built documents for a much better output quality and less allucinations and unexpected results.